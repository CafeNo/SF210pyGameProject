...
class PlayMenu:
    ...
    def __init__(self,loginScreen) -> None:  
        ...
        self.btn_play = Button(self.window,"./assets/play_menu/pic_play.png", "./assets/play_menu/pic_play_hover.png", 627, 372)
        self.btn_max_score = Button(self.window,"./assets/play_menu/pic_max_score.png", "./assets/play_menu/pic_max_score_hover.png", 627, 472)
        self.btn_logout = Button(self.window,"./assets/play_menu/pic_logout.png", "./assets/play_menu/pic_logout_hover.png", 627, 574)
